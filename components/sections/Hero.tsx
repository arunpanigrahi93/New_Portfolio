        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center min-h-[calc(100vh-80px)]">
          ...
          <div className="flex flex-col gap-6 order-2 lg:order-1">
            ...
            <div>
              ...
              <h1
                id="hero-heading"
                className="font-display text-2xl sm:text-6xl xl:text-7xl font-bold tracking-tight leading-[1.05]"
                style={{ color: "var(--text)" }}
              >
                Venkata <span className="gradient-text">Arunakumar</span>
                <br />
                <span style={{ color: "var(--text)" }}>Panigrahi</span>
              </h1>
            </div>
          ...
          <div className="flex flex-col items-center gap-8 order-1 lg:order-2">
            ...
            <div className="relative" aria-hidden="true">
              ...
              <div
                ...
                style={{
                  background:
                    "conic-gradient(from 0deg, var(--primary) 0%, transparent 40%, var(--accent) 60%, transparent 80%, var(--primary) 100%)",
                  borderRadius: "50%",
                  padding: "2px",
