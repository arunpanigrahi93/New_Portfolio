    ...
    >
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="mt-16 grid grid-cols-1 lg:grid-cols-5 gap-10">
          {/* Left — Contact info */}
          <div
            className={`lg:col-span-2 flex flex-col gap-6 reveal ${isVisible ? "visible" : ""} reveal-delay-1`}
          >
            <div
              ...
              <div className="flex flex-col gap-4">
                {contactInfo.map((item) => (
                  ...
                  >
                    ...
                    <div>
                      <p
                        className="text-xs font-mono font-semibold uppercase tracking-wider mb-0.5"
          ...
          {/* Right — Form */}
          <div
            className={`lg:col-span-3 reveal ${isVisible ? "visible" : ""} reveal-delay-2`}
          >
            <form
